...
local EpisodeStatusEntity = {}
EpisodeStatusEntity.__index = EpisodeStatusEntity


function EpisodeStatusEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EpisodeStatusEntity)
  self._name = "episode_status"
  self._client = client
...
function EpisodeStatusEntity:get_name()
  return self._name
end


function EpisodeStatusEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EpisodeStatusEntity.new(self._client, opts)
end
...
function EpisodeStatusEntity:mark_deleted()
  self._deleted = true
end


function EpisodeStatusEntity:deleted()
  return true == self._deleted
end


function EpisodeStatusEntity:data_set(args)
  if args ~= nil then
...
function EpisodeStatusEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EpisodeStatusEntity:match_set(args)
  if args ~= nil then
...
function EpisodeStatusEntity:match_get()
...
function EpisodeStatusEntity:stream(action, args, callopts)
...
---@param reqmatch EpisodeStatusLoadMatch
---@param ctrl? table
---@return EpisodeStatus
---@return string? err
function EpisodeStatusEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function EpisodeStatusEntity:_run_op(ctx, post_done)
  local utility = self._utility
