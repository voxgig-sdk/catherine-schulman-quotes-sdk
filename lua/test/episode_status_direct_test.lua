...
describe("EpisodeStatusDirect", function()
  it("should direct-load-episode_status", function()
    local setup = episode_status_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-episode_status", setup.live and "live" or "unit")
