// Command CatherineSchulmanQuotes-mcp is an MCP server exposing the CatherineSchulmanQuotes
// SDK as MCP tools.
//
// Two tools are registered:
//
//	CatherineSchulmanQuotes_list  — list records of an entity
//	CatherineSchulmanQuotes_load  — load a single record of an entity
//
