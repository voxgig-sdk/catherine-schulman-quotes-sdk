...
#      offline in seeded test mode (CatherineSchulmanQuotesSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "CatherineSchulmanQuotes_sdk.rb")
  SDK_CLASS = "CatherineSchulmanQuotesSDK"
  ...
  SDK_BASE = "CatherineSchulmanQuotes_sdk"
