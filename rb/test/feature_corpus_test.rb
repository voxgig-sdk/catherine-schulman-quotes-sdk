# CatherineSchulmanQuotes SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # CatherineSchulmanQuotesSDK.new, not CatherineSchulmanQuotesSDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    CatherineSchulmanQuotesSDK.new(opts)
  end
