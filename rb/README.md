# CatherineSchulmanQuotes Ruby SDK



The Ruby SDK for the CatherineSchulmanQuotes API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `CatherineSchulmanQuotesError` (a `StandardError` subclass), so wrap
...
```
rb/
├── CatherineSchulmanQuotes_sdk.rb       -- Main SDK module
...
The main module (`CatherineSchulmanQuotes_sdk`) exports the SDK class
