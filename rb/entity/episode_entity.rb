# CatherineSchulmanQuotes SDK Episode entity
...
class EpisodeEntity
  ...
  # @return [Episode, Hash] the loaded Episode; raises CatherineSchulmanQuotesError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Episode>, Array] the matching Episode items; raises CatherineSchulmanQuotesError on failure
