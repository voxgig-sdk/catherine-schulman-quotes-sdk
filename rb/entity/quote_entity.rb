# CatherineSchulmanQuotes SDK Quote entity
...
class QuoteEntity
  ...
  # @return [Quote, Hash] the loaded Quote; raises CatherineSchulmanQuotesError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Quote>, Array] the matching Quote items; raises CatherineSchulmanQuotesError on failure
