# CatherineSchulmanQuotes Python SDK



The Python SDK for the CatherineSchulmanQuotes API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/catherine-schulman-quotes-sdk/releases)) or
...
```python
quotes = client.Quote().list({"q": "example"})
```
...
```
py/
├── catherineschulmanquotes_sdk.py         -- Main SDK module
