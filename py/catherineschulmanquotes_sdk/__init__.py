...
from catherineschulmanquotes_sdk.utility import register

# Load features
from catherineschulmanquotes_sdk.feature.base_feature import CatherineSchulmanQuotesBaseFeature
from catherineschulmanquotes_sdk.features import _has_feature, _make_feature
...
class CatherineSchulmanQuotesSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = CatherineSchulmanQuotesUtility()
        self._utility = utility

        from catherineschulmanquotes_sdk.config import shared_config
    ...
    def get_utility(self):
        return CatherineSchulmanQuotesUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("CatherineSchulmanQuotesSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Episode(self, data=None) -> "EpisodeEntity":
        ...
        from catherineschulmanquotes_sdk.entity.episode_entity import EpisodeEntity
        return EpisodeEntity(self, data)


    def EpisodeStatus(self, data=None) -> "EpisodeStatusEntity":
        """Entity factory: client.EpisodeStatus().list() / client.EpisodeStatus().load({"id": ...})."""
        from catherineschulmanquotes_sdk.entity.episode_status_entity import EpisodeStatusEntity
        return EpisodeStatusEntity(self, data)


    def Quote(self, data=None) -> "QuoteEntity":
        """Entity factory: client.Quote().list() / client.Quote().load({"id": ...})."""
        from catherineschulmanquotes_sdk.entity.quote_entity import QuoteEntity
        return QuoteEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "CatherineSchulmanQuotesSDK":
        if sdkopts is None:
            sdkopts = {}
