...
from catherineschulmanquotes_sdk.catherineschulmanquotes_types import (
    EpisodeStatus,
...
class EpisodeStatusEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EpisodeStatusEntity(self._client, opts)
    ...
    def data_get(self) -> EpisodeStatus:
    ...
    def match_get(self) -> EpisodeStatus:
    ...
    def load(self, reqmatch=None, ctrl=None) -> EpisodeStatus:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.EpisodeStatus().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
