...
Catherine Schulman Quotes client, generated from the OpenAPI spec.

This API provides access to a collection of quotes attributed to Catherine Schulman.

Learn more about Catherine Schulman Quotes at [shulmanquotes.vercel.app](https://shulmanquotes.vercel.app).

This is an unofficial SDK for the Catherine Schulman Quotes public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
This SDK exposes the API as a small set of **semantic entities** — Episode, EpisodeStatus and Quote — that you
...
const items = await client.Episode().list()
```
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/catherine-schulman-quotes-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/catherine-schulman-quotes-sdk/tags) |
| Python | `voxgig-sdk-catherine-schulman-quotes` | publish pending — [install from git tag](https://github.com/voxgig-sdk/catherine-schulman-quotes-sdk/tags) |
| PHP | `voxgig-sdk/catherine-schulman-quotes` | publish pending — [install from git tag](https://github.com/voxgig-sdk/catherine-schulman-quotes-sdk/tags) |
...
| Ruby | `voxgig-sdk-catherine-schulman-quotes` | publish pending — [install from git tag](https://github.com/voxgig-sdk/catherine-schulman-quotes-sdk/tags) |
| Lua | `voxgig-sdk-catherine-schulman-quotes` | publish pending — [install from git tag](https://github.com/voxgig-sdk/catherine-schulman-quotes-sdk/tags) |
| Go CLI | `github.com/voxgig-sdk/catherine-schulman-quotes-sdk/go-cli` | `go install github.com/voxgig-sdk/catherine-schulman-quotes-sdk/go-cli/cmd/catherine-schulman-quotes@latest` |
| Go MCP server | `github.com/voxgig-sdk/catherine-schulman-quotes-sdk/go-mcp` | `go get github.com/voxgig-sdk/catherine-schulman-quotes-sdk/go-mcp@latest` |
...
```bash
cd go-mcp && go build -o catherine-schulman-quotes-mcp .
```
...
```json
{
  "mcpServers": {
    "catherine-schulman-quotes": {
      "command": "/abs/path/to/catherine-schulman-quotes-mcp"
    }
  }
}
```
...
| --- | --- | --- |
| **Episode** | The Episode entity (list, load). | `/last/episodes/all` |
| **EpisodeStatus** | The EpisodeStatus entity (load). | `/last/episodes/status` |
| **Quote** | The Quote entity (list, load). | `/search` |
...
# List all episodes (returns a list, raises on error)
episodes = client.Episode().list()
...
// List all episodes (returns an array; throws on error)
$episodes = $client->Episode()->list();
print_r(array_map(fn($item) => $item->data_get(), $episodes));
...
```go
import sdk "github.com/voxgig-sdk/catherine-schulman-quotes-sdk/go"
...
# List all episodes (returns an Array; raises on error)
episodes = client.Episode.list
puts episodes
...
Generated from the Catherine Schulman Quotes OpenAPI spec by [@voxgig/sdkgen](https://github.com/voxgig/sdkgen).
