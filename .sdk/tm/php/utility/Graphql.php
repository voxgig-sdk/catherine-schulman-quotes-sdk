...
// CatherineSchulmanQuotes SDK utility: graphql
//
...
class CatherineSchulmanQuotesGraphql
{
    ...
    // equivalent.
    public static function body(CatherineSchulmanQuotesContext $ctx): mixed
    {
    ...
    public static function errors(CatherineSchulmanQuotesContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
