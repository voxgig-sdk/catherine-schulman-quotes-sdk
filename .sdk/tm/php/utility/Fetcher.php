...
// CatherineSchulmanQuotes SDK utility: fetcher

class CatherineSchulmanQuotesFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CatherineSchulmanQuotesSDK/1.0)';
    ...
    public static function call(CatherineSchulmanQuotesContext $ctx, string $fullurl, array $fetchdef): array
    {
