...
// CatherineSchulmanQuotes SDK utility: make_options

class CatherineSchulmanQuotesMakeOptions
{
    ...
    public static function call(CatherineSchulmanQuotesContext $ctx): array
    {
        ...
        //
        // `CatherineSchulmanQuotesSchema::optspec()` is built from the model:
        ...
        $optspec = CatherineSchulmanQuotesSchema::optspec();
