...
// CatherineSchulmanQuotes SDK ratelimit feature
...
class CatherineSchulmanQuotesRatelimitFeature extends CatherineSchulmanQuotesBaseFeature
{
    ...
    private function _acquire(CatherineSchulmanQuotesContext $ctx): void
    {
    ...
    private function _track(CatherineSchulmanQuotesContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
