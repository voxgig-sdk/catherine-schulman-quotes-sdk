...
// CatherineSchulmanQuotes SDK netsim feature
...
class CatherineSchulmanQuotesNetsimFeature extends CatherineSchulmanQuotesBaseFeature
{
    ...
    private function _simulate(CatherineSchulmanQuotesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(CatherineSchulmanQuotesContext $ctx, array $applied): void
    {
        $client = $this->client;
