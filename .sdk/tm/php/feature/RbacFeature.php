...
// CatherineSchulmanQuotes SDK rbac feature
...
class CatherineSchulmanQuotesRbacFeature extends CatherineSchulmanQuotesBaseFeature
{
    ...
    private function _required(CatherineSchulmanQuotesContext $ctx): ?string
    {
    ...
    private function _reject(CatherineSchulmanQuotesContext $ctx, string $required): void
    {
    ...
    private function _track(CatherineSchulmanQuotesContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
