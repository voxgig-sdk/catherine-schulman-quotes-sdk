...
def make_error_util(ctx, err):
    if ctx is None:
        ...
        ctx = CatherineSchulmanQuotesContext({}, None)
    ...
    result = ctx.result
    if result is None:
        result = CatherineSchulmanQuotesResult({})
    result.ok = False
    ...
    errmsg = ""
    if isinstance(err, CatherineSchulmanQuotesError):
        errmsg = err.msg
    ...
    sdk_err = CatherineSchulmanQuotesError("", msg, ctx)
