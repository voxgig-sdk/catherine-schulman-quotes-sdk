...
class CatherineSchulmanQuotesTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CatherineSchulmanQuotesTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = CatherineSchulmanQuotesTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = CatherineSchulmanQuotesTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
