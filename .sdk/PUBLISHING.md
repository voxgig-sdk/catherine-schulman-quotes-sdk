...
|---|---|---|
| `ts/` | @voxgig-sdk/catherine-schulman-quotes-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/catherine-schulman-quotes-sdk \
      --repository voxgig-sdk/catherine-schulman-quotes-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/catherine-schulman-quotes-sdk` shows it, and
`npm trust revoke @voxgig-sdk/catherine-schulman-quotes-sdk --id=<id>` removes it.
