...
// CatherineSchulmanQuotes SDK utility type

class CatherineSchulmanQuotesUtility
{
    ...
    public static function copy(CatherineSchulmanQuotesUtility $src): CatherineSchulmanQuotesUtility
    {
        $u = new CatherineSchulmanQuotesUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
