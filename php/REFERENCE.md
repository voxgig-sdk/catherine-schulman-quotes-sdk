# CatherineSchulmanQuotes PHP SDK Reference

Complete API reference for the CatherineSchulmanQuotes PHP SDK.
...
#### `CatherineSchulmanQuotesSDK::test($testopts = null, $sdkopts = null)`
...
#### `EpisodeStatus($data = null)`

Create a new `EpisodeStatusEntity` instance. Pass `null` for no initial data.
...
#### `get_utility(): CatherineSchulmanQuotesUtility`
