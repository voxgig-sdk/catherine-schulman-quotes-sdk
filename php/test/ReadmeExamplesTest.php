...
// CatherineSchulmanQuotes SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CatherineSchulmanQuotesSDK::test)
...
{
    private const SDK_CLASS = 'CatherineSchulmanQuotesSDK';
    ...
    private const SDK_BASE = 'catherineschulmanquotes_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../catherineschulmanquotes_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
