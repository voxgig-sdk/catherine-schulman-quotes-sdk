...
// CatherineSchulmanQuotes SDK cache feature
...
class CatherineSchulmanQuotesCacheFeature extends CatherineSchulmanQuotesBaseFeature
{
    ...
    private function _through(CatherineSchulmanQuotesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
