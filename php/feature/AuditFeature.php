...
// CatherineSchulmanQuotes SDK audit feature
...
class CatherineSchulmanQuotesAuditFeature extends CatherineSchulmanQuotesBaseFeature
{
    ...
    private function _emit(CatherineSchulmanQuotesContext $ctx, string $outcome): void
    {
