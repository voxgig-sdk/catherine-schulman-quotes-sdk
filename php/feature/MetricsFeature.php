...
// CatherineSchulmanQuotes SDK metrics feature
...
class CatherineSchulmanQuotesMetricsFeature extends CatherineSchulmanQuotesBaseFeature
{
    ...
    private function _record(CatherineSchulmanQuotesContext $ctx, bool $ok): void
    {
