...
// CatherineSchulmanQuotes SDK telemetry feature
...
class CatherineSchulmanQuotesTelemetryFeature extends CatherineSchulmanQuotesBaseFeature
{
    ...
    private function _close(CatherineSchulmanQuotesContext $ctx, bool $ok): void
    {
