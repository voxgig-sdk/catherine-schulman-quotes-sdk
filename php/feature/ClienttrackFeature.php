...
// CatherineSchulmanQuotes SDK clienttrack feature
...
class CatherineSchulmanQuotesClienttrackFeature extends CatherineSchulmanQuotesBaseFeature
{
    ...
    public function PostConstruct(CatherineSchulmanQuotesContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'CatherineSchulmanQuotes-SDK';
