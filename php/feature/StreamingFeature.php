...
// CatherineSchulmanQuotes SDK streaming feature
...
class CatherineSchulmanQuotesStreamingFeature extends CatherineSchulmanQuotesBaseFeature
{
    ...
    private function _iterate(CatherineSchulmanQuotesResult $result): \Generator
    {
    ...
    private function _streamable(CatherineSchulmanQuotesContext $ctx): bool
    {
