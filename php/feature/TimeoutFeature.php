...
// CatherineSchulmanQuotes SDK timeout feature
...
class CatherineSchulmanQuotesTimeoutFeature extends CatherineSchulmanQuotesBaseFeature
{
    ...
    private function _with_timeout(CatherineSchulmanQuotesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CatherineSchulmanQuotesContext $_ctx, float $ms): void
    {
        $client = $this->client;
