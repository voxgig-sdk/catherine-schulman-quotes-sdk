...
// CatherineSchulmanQuotes SDK proxy feature
...
class CatherineSchulmanQuotesProxyFeature extends CatherineSchulmanQuotesBaseFeature
{
    ...
    public function init(CatherineSchulmanQuotesContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CatherineSchulmanQuotesContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
