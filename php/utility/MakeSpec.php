...
// CatherineSchulmanQuotes SDK utility: make_spec

require_once __DIR__ . '/Graphql.php';

require_once __DIR__ . '/../core/Spec.php';

class CatherineSchulmanQuotesMakeSpec
{
    public static function call(CatherineSchulmanQuotesContext $ctx): array
    {
        ...
        if ('graphql' === \Voxgig\Struct\Struct::getprop($point, 'kind')) {
            ...
            $ctx->spec->query = [];
            $ctx->spec->headers['content-type'] = CatherineSchulmanQuotesGraphql::CONTENT_TYPE;
        } else {
