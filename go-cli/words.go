...
func registerSDKWords(r *eng.Registry, client *sdk.CatherineSchulmanQuotesSDK) {
...
func runOp(client *sdk.CatherineSchulmanQuotesSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
