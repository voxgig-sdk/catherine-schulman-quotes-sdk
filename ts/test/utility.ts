...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.CATHERINESCHULMANQUOTES_TEST_LIVE ||
    'TRUE' === process.env.CATHERINESCHULMANQUOTES_TEST_OVERRIDE
  ) {
  ...
  m.CATHERINESCHULMANQUOTES_TEST_EXPLAIN = process.env.CATHERINESCHULMANQUOTES_TEST_EXPLAIN || m.CATHERINESCHULMANQUOTES_TEST_EXPLAIN
