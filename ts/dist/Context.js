...
const CatherineSchulmanQuotesError_1 = require("./CatherineSchulmanQuotesError");
...
class Context {
    ...
    error(code, msg) {
        return new CatherineSchulmanQuotesError_1.CatherineSchulmanQuotesError(code, msg, this);
    }
    toJSON() {
        return {
            id: this.id,
