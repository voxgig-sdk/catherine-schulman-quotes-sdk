# CatherineSchulmanQuotes TypeScript SDK



The TypeScript SDK for the CatherineSchulmanQuotes API — a type-safe, entity-oriented client with full async/await support.
...
- Releases: [https://github.com/voxgig-sdk/catherine-schulman-quotes-sdk/releases](https://github.com/voxgig-sdk/catherine-schulman-quotes-sdk/releases)
...
```ts
new CatherineSchulmanQuotesSDK(options?: {
  base?: string
  prefix?: string
  suffix?: string
...
| `EpisodeStatus(data?)` | `EpisodeStatusEntity` | Create an EpisodeStatus entity instance. |
| `Quote(data?)` | `QuoteEntity` | Create a Quote entity instance. |
| `tester(testopts?, sdkopts?)` | `CatherineSchulmanQuotesSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `CatherineSchulmanQuotesSDK.test(testopts?, sdkopts?)` | `CatherineSchulmanQuotesSDK` | Create a test-mode client. |
...
| `client` | `client(): CatherineSchulmanQuotesSDK` | Return the parent SDK client. |
...
Create an instance: `const episode_status = client.EpisodeStatus()`
...
```ts
const episode_status = await client.EpisodeStatus().load()
```
...
```ts
const quotes = await client.Quote().list({ q: "example" })
```
...
├── src/
│   ├── CatherineSchulmanQuotesSDK.ts        # Main SDK class
