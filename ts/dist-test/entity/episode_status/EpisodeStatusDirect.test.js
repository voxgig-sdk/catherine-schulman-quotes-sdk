...
(0, node_test_1.describe)('EpisodeStatusDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.CatherineSchulmanQuotesSDK({
    ...
    (0, node_test_1.test)('direct-load-episode_status', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-episode_status', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.CATHERINE_SCHULMAN_QUOTES_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.CatherineSchulmanQuotesSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['CATHERINE_SCHULMAN_QUOTES_TEST_EPISODE_STATUS_ENTID'];
    ...
    const client = new __1.CatherineSchulmanQuotesSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=EpisodeStatusDirect.test.js.map