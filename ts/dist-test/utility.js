...
function envOverride(m) {
    if ('TRUE' === process.env.CATHERINE_SCHULMAN_QUOTES_TEST_LIVE ||
        'TRUE' === process.env.CATHERINE_SCHULMAN_QUOTES_TEST_OVERRIDE) {
    ...
    m.CATHERINE_SCHULMAN_QUOTES_TEST_EXPLAIN = process.env.CATHERINE_SCHULMAN_QUOTES_TEST_EXPLAIN || m.CATHERINE_SCHULMAN_QUOTES_TEST_EXPLAIN;
    return m;
}
