...
import (
	...
	vs "github.com/voxgig-sdk/catherine-schulman-quotes-sdk/go/utility/struct"
)

type EpisodeStatusEntity struct {
	name    string
	client  *core.CatherineSchulmanQuotesSDK
...
func NewEpisodeStatusEntity(client *core.CatherineSchulmanQuotesSDK, entopts map[string]any) *EpisodeStatusEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EpisodeStatusEntity) GetName() string { return e.name }
...
func (e *EpisodeStatusEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EpisodeStatusEntity) Deleted() bool {
	return e.deleted
}


func (e *EpisodeStatusEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEpisodeStatusEntity(e.client, opts)
}

func (e *EpisodeStatusEntity) Data(args ...any) any {
...
func (e *EpisodeStatusEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an EpisodeStatus; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EpisodeStatusEntity) DataTyped(data ...EpisodeStatus) EpisodeStatus {
	if len(data) > 0 {
		return typedFrom[EpisodeStatus](e.Data(asMap(data[0])))
	}
	return typedFrom[EpisodeStatus](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through EpisodeStatus (all fields
// optional at the wire level).
func (e *EpisodeStatusEntity) MatchTyped(match ...EpisodeStatus) EpisodeStatus {
	if len(match) > 0 {
		return typedFrom[EpisodeStatus](e.Match(asMap(match[0])))
	}
	return typedFrom[EpisodeStatus](e.Match())
}
...
func (e *EpisodeStatusEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EpisodeStatusEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EpisodeStatusLoadMatch and returns an EpisodeStatus. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *EpisodeStatusEntity) LoadTyped(reqmatch EpisodeStatusLoadMatch, ctrl map[string]any) (EpisodeStatus, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return EpisodeStatus{}, err
	}
	return typedFrom[EpisodeStatus](res), nil
}



func (e *EpisodeStatusEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *EpisodeStatusEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *EpisodeStatusEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EpisodeStatusEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EpisodeStatusEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
