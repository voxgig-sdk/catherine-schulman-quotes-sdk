...
import "github.com/voxgig-sdk/catherine-schulman-quotes-sdk/go/core"
...
func makeErrorUtil(ctx *core.Context, err error) (any, error) {
	...
	sdkErr := &core.CatherineSchulmanQuotesError{
	...
	if se, ok := err.(*core.CatherineSchulmanQuotesError); ok {
		sdkErr.Code = se.Code
	}
