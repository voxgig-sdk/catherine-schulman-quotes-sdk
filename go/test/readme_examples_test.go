...
const testSeed = `map[string]any{"entity": map[string]any{"episode": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "episode_status": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "quote": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
