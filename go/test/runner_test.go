...
func envOverride(m map[string]any) map[string]any {
	if os.Getenv("CATHERINESCHULMANQUOTES_TEST_LIVE") == "TRUE" ||
		os.Getenv("CATHERINESCHULMANQUOTES_TEST_OVERRIDE") == "TRUE" {
		for key := range m {
	...
	if explain := os.Getenv("CATHERINESCHULMANQUOTES_TEST_EXPLAIN"); explain != "" {
